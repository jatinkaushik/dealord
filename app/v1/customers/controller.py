...
def customer_info(json_data):
    try:
        customer_info_obj = CustomersInfo(customer_id= json_data['customer_id'],legal_name = json_data['legal_name'],gstin_no = json_data['gstin_no'],cin_no = json_data['cin_no'],website = json_data['website'],email = json_data['email'],phone_no = json_data['phone_no'],fax = json_data['fax']) 
...
def customer_address(json_data):
    try:
        customer_address_obj = CustomersAddress(customer_id= json_data['customer_id'],address_line_1 = json_data['address_line_1'],address_line_2 = json_data['address_line_2'],district = json_data['district'],city_town = json_data['city_town'],landmark = json_data['landmark'],state = json_data['state'],country = json_data['country'])
